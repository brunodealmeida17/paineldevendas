                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="forgot-password.html">Deseja redefinir a senha?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="<c:url value="login"/>">Tem conta? Realize o Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
